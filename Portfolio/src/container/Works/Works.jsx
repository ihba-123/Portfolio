...
const Works = () => {
  ...
  useEffect(() => {
    ...
    client
      ...
      .catch((err) => console.error("Error fetching works:", err)); // Improved error logging
  }, []);
  ...
  return (
    <>
    <h2 className="head-text"style={{color:"grey"}}>My Creative <span>Portfolio</span> Section</h2>
